...
Page.Home = new Class({
    ...
    createSoon: function() {
        ...
        self.soon_list = new MovieList({
            ...
            actions: [ MA.IMDB, MA.Filmaffinity, MA.Release, MA.Trailer, MA.Refresh, MA.Delete, MA.Category, MA.Profile ],
            load_more: false,
            view: "thumb",
            force_view: true,
    ...
    createSuggestions: function() {
        ...
        self.suggestions_list = new MovieList({
            ...
            actions: [ MA.Add, MA.SuggestIgnore, MA.SuggestSeen, MA.IMDB, MA.Filmaffinity, MA.Trailer ],
            load_more: false,
            view: "thumb",
            force_view: true,
    ...
    createLate: function() {
        ...
        self.late_list = new MovieList({
            ...
            load_more: false,
            view: "list",
            actions: [ MA.IMDB, MA.Filmaffinity, MA.Trailer, MA.Refresh, MA.Delete, MA.Category, MA.Profile ],
            api_call: "dashboard.soon",
            onLoaded: function() {
                self.chain.callChain();
            }
